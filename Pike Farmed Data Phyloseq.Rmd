---
title: "Pike Farmed Data Phyloseq"
author: "Karen"
date: '2022-05-09'
...
## Set path to folder
```{r}
path <- "C:/Users/Karen/Documents/ProjectDada/fastqfiles/Pike/Pike Farmed" # CHANGE ME to the directory containing the fastq files after unzipping.
# see the files
list.files(path)
```
...
##
```{r}
write.csv(as.matrix(t(seqtab.nochim)), "seqtabPkF.csv")
```
...
write.csv(as.matrix((taxid)), "taxIDPkF.csv")
head(taxid)
```
